    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 overflow-hidden">
      {!isSidebarOpen && (
        <button
          ...
          className="lg:hidden fixed z-50 p-3 rounded-xl shadow-lg
        ...
        {(isSidebarOpen || (typeof window !== 'undefined' && window.innerWidth >= 1024)) && (
          ...
          >
            <div className="flex flex-col h-full">
              {/* Logo Section with extra top padding to avoid overlap */}
              <div className="p-6 pt-8 border-b border-gray-100 dark:border-gray-700" 
                   style={{ marginTop: 'max(0px, calc(env(safe-area-inset-top)))' }}>
                    ...
                    return (
                      <li key={item.path}>
                        ...
                        >
                          ...
                          {/* Only show lock icon if premium is required AND user is NOT premium */}
